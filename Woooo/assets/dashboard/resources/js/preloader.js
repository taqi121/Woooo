(function ($) {
	$(document).ready(function () {
		...
		//SignUp
		$('.sign-up-link b').on('click', function (e) {
			if ($(".sign-up").hasClass("active")) {
				$("body").toggleClass("overflow");
				$(".sign-up").removeClass("active");
				$(".sign-up").css("transition-delay", "0.5s");
				$(".sign-up .layer").css("transition-delay", "0.3s");
				$(".sign-up .inner").css("transition-delay", "0s");
			} else {
				$(".sign-up").addClass('active');
				$("body").toggleClass("overflow");
				$(".sign-up.active").css("transition-delay", "0s");
				$(".sign-up.active .layer").css("transition-delay", "0.2s");
				$(".sign-up.active .inner").css("transition-delay", "0.7s");
			}

		});
		//SignUp
		$('.sign-in-link b').on('click', function (e) {
			if ($(".sign-in").hasClass("active")) {
				$("body").toggleClass("overflow");
				$(".sign-in").removeClass("active");
				$(".sign-in").css("transition-delay", "0.5s");
				$(".sign-in .layer").css("transition-delay", "0.3s");
				$(".sign-in .inner").css("transition-delay", "0s");
			} else {
				$(".sign-in").addClass('active');
				$("body").toggleClass("overflow");
				$(".sign-in.active").css("transition-delay", "0s");
				$(".sign-in.active .layer").css("transition-delay", "0.2s");
				$(".sign-in.active .inner").css("transition-delay", "0.7s");
			}
